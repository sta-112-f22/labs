...
3. We are interested in whether age at diagnosis influences the probability of responding to treatment. Consider the available variables in your dataset and propose a model to assess the relationship between age at diagnosis and the probability (or odds) of responding to treatment. What variables are you including in your model? Why?
