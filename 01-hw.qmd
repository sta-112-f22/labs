...
```{bash}
#| eval: false
https://github.com/sta-112-f22/hw-01-multiple-linear-regression.git
```
...
6. A diamond sales person has a shipment of diamonds with a depth of 60 and "internally flawless" clarity. They want to know what the average total price will be for these diamonds. Report this value along with an appropriate confidence interval.

7. Your relative has a diamond with a depth of 59.7 and slightly included clarity (2)-- they want to know what you would predict the total price for this diamond would be. Report this value along with the appropriate confidence interval.